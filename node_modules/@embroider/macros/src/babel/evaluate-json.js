...
class Evaluator {
    ...
    evaluateMacroCall(path) {
        ...
        if (callee.referencesImport('@embroider/macros', 'getConfig')) {
            return { confident: true, value: (0, get_config_1.default)(path, this.state, 'package'), hasRuntimeImplementation: true };
        }
        if (callee.referencesImport('@embroider/macros', 'getOwnConfig')) {
            return { confident: true, value: (0, get_config_1.default)(path, this.state, 'own'), hasRuntimeImplementation: true };
        }
        if (callee.referencesImport('@embroider/macros', 'getGlobalConfig')) {
            return { confident: true, value: (0, get_config_1.default)(path, this.state, 'getGlobalConfig'), hasRuntimeImplementation: true };
        }
